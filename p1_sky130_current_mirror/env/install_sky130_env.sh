...
echo "   git clone https://github.com/<YOUR_GITHUB_USERNAME>/rebalance_criteria.git p1_sky130_current_mirror"
echo "   # GitHub를 안 쓸 때: ./restore_from_bundle.sh /path/to/rebalance_criteria.bundle p1_sky130_current_mirror main"
